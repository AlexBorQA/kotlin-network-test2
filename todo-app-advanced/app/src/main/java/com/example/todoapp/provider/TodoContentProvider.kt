        ...
        return when (uriMatcher.match(uri)) {
            TODOS -> {
                runBlocking {
                    ...
                    // Преобразуем Flow в список для курсора
                    // В реальном приложении лучше использовать LiveData или другой механизм
                    createCursorFromTodos(emptyList()) // Упрощенная реализация
                }
            }
            TODO_ID -> {
